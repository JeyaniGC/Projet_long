...
# For Teff analysis
# Analysis RAvsHV
# In tcr_sig subset with Teff, RA and enriched data
ra_sig <- tcr_sig %>% 
...
# we have the same patients in both label
...
pdf("Heatmap_RAvsHV_Teff.pdf",width =50, height =50)
...
pdf("Heatmap_T1DvsHV_Teff.pdf",width =50, height =50)
